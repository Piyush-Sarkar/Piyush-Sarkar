...
int main() {
  ...
  switch(ch)
  {
    ...
    case 2: printf("Enter element for deletion\n");
            ...
            delete(item,root);
            break;
    case 3: printf("Displaying the elements by preorder traversal\n");
            preorder(root);
            printf("\n");
            break;
    case 4: printf("Displaying the elements by inorder traversal\n");
            inorder(root);
            printf("\n");
            break;
    case 5: printf("Displaying the elements by postorder traversal\n");
            postorder(root);
            printf("\n");
            break;
    case 6: return 0;
